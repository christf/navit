...
struct widget *gui_internal_button_navit_attr_new(struct gui_priv *this, const char *text, enum flags flags,
    ...
    ret->cb =
        callback_new_attr_2(callback_cast(gui_internal_button_attr_callback), on ? on->type : off->type, this, ret);
...
void gui_internal_apply_config(struct gui_priv *this) {
    ...
    if (!this->fonts[0]) {
        ...
        for (i = 0; i < 3; i++) {
            if (this->font_name)
                this->fonts[i] =
                    graphics_named_font_new(this->gra, this->font_name, this->font_size * sizes[i] / 100, 1);
            else
 ...
 *
 * Widget passed as wm parameter of the called cmd function will have item set to user chosen waypoint item. Its data
 * will be set to zero-based chosen waypoint number, counting from the route end. Coordinates to wm->c will be copied
 * from wm_->c if wm_ is not null. Otherwise, waypoint coordinates will be copied to wm->c.
 *
...
void gui_internal_select_waypoint(struct gui_priv *this, const char *title, const char *hint, struct widget *wm_,
    ...
    while ((item = map_rect_get_item(mr)) != NULL) {
        ...
        gui_internal_widget_append(
            wtable, row = gui_internal_widget_table_row_new(this, gravity_left | orientation_horizontal | flags_fill));
        gui_internal_widget_append(row, wc = gui_internal_button_new_with_callback(
                                            this, text, image_new_xs(this, "gui_active"),
...
/**
 * @brief Generic notification function for Editable widgets to call Another widget notification function when Enter is
 * pressed in editable field. The Editable widget should have data member pointing to the Another widget.
 */
...
static void gui_internal_cmd_view_on_map(struct gui_priv *this, struct widget *wm, void *data) {
    ...
    if (wm->item.type != type_none) {
        ...
        gui_internal_widget_append(wr, wi = gui_internal_box_new_with_label(
                                           this, 0, label)); /* That row contains a widget of type widget_box */
...
static void gui_internal_cmd_view_attribute_details(struct gui_priv *this, struct widget *wm, void *data) {
    ...
    if (item_attr_get(item, attr_any, &attr)) {
        ...
        if (url) {
            gui_internal_widget_append(w, wb = gui_internal_button_new_with_callback(
                                              this, _("View in Browser"), image_new_xs(this, "gui_active"),
...
static void gui_internal_cmd_view_attributes(struct gui_priv *this, struct widget *wm, void *data) {
    ...
    if (item) {
        ...
        gui_internal_widget_append(w, wb = gui_internal_button_new(
                                          this, text, NULL, gravity_left_center | orientation_horizontal | flags_fill));
        ...
        while (item_attr_get(item, attr_any, &attr)) {
            ...
            g_free(attrtxt);
            gui_internal_widget_append(
                w, wb = gui_internal_button_new_with_callback(this, text, NULL,
                                                              gravity_left_center | orientation_horizontal | flags_fill,
...
void gui_internal_cmd_position_do(struct gui_priv *this, const struct pcoord *pc_in, struct coord_geo *g_in,
    ...
    if ((flags & 1) && wm) {
        gui_internal_widget_append(
            wtable, row = gui_internal_widget_table_row_new(this, gravity_left | orientation_horizontal | flags_fill));
        gui_internal_widget_append(
            row, wc = gui_internal_button_new_with_callback(this, _("Streets"), image_new_xs(this, "gui_active"),
                                                            gravity_left_center | orientation_horizontal | flags_fill,
    ...
    if ((flags & 2) && wm) {
        gui_internal_widget_append(
            wtable, row = gui_internal_widget_table_row_new(this, gravity_left | orientation_horizontal | flags_fill));
        gui_internal_widget_append(
            row, wc = gui_internal_button_new_with_callback(this, _("House numbers"), image_new_xs(this, "gui_active"),
                                                            gravity_left_center | orientation_horizontal | flags_fill,
        ...
        if (item) {
            if (item_attr_get(item, attr_description, &attr))
                gui_internal_widget_append(w,
                                           gui_internal_label_new(this, map_convert_string_tmp(item->map, attr.u.str)));
            if (item_attr_get(item, attr_url_local, &attr)) {
                gui_internal_widget_append(wtable, row = gui_internal_widget_table_row_new(
                                                       this, gravity_left | orientation_horizontal | flags_fill));
                gui_internal_widget_append(row, wb = gui_internal_button_new_with_callback(
                                                    this, _("View in Browser"), image_new_xs(this, "gui_active"),
                                                    gravity_left_center | orientation_horizontal | flags_fill,
                                                    gui_internal_cmd_view_in_browser, NULL));
                wb->item = wm->item;
            ...
            gui_internal_widget_append(wtable, row = gui_internal_widget_table_row_new(
                                                   this, gravity_left | orientation_horizontal | flags_fill));
            gui_internal_widget_append(row, wb = gui_internal_button_new_with_callback(
                                                this, _("View Attributes"), image_new_xs(this, "gui_active"),
                                                gravity_left_center | orientation_horizontal | flags_fill,
    ...
    if (flags & 8) {
        gui_internal_widget_append(
            wtable, row = gui_internal_widget_table_row_new(this, gravity_left | orientation_horizontal | flags_fill));
        gui_internal_widget_append(row, wbc = gui_internal_button_new_with_callback(
                                            this, _("Set as destination"), image_new_xs(this, "gui_active"),
                                            gravity_left_center | orientation_horizontal | flags_fill,
        ...
        if (navit_get_destination_count(this->nav) >= 1) {
            gui_internal_widget_append(wtable, row = gui_internal_widget_table_row_new(
                                                   this, gravity_left | orientation_horizontal | flags_fill));
            gui_internal_widget_append(row, wbc = gui_internal_button_new_with_callback(
                                                this, _("Visit before..."), image_new_xs(this, "gui_active"),
                                                gravity_left_center | orientation_horizontal | flags_fill,
    ...
    if (flags & 16) {
        ...
        gui_internal_widget_append(
            wtable, row = gui_internal_widget_table_row_new(this, gravity_left | orientation_horizontal | flags_fill));
        gui_internal_widget_append(
            row, wbc = gui_internal_button_new_with_callback(this, text, image_new_xs(this, "gui_active"),
                                                             gravity_left_center | orientation_horizontal | flags_fill,
    ...
    if (flags & 32) {
        gui_internal_widget_append(
            wtable, row = gui_internal_widget_table_row_new(this, gravity_left | orientation_horizontal | flags_fill));
        gui_internal_widget_append(row, wbc = gui_internal_button_new_with_callback(
                                            this, _("Add as bookmark"), image_new_xs(this, "gui_active"),
                                            gravity_left_center | orientation_horizontal | flags_fill,
    ...
    if (flags & 64) {
        gui_internal_widget_append(
            wtable, row = gui_internal_widget_table_row_new(this, gravity_left | orientation_horizontal | flags_fill));
        gui_internal_widget_append(
            row, wbc = gui_internal_button_new_with_callback(this, _("POIs"), image_new_xs(this, "gui_active"),
                                                             gravity_left_center | orientation_horizontal | flags_fill,
    ...
    if (flags & 128) {
        gui_internal_widget_append(
            wtable, row = gui_internal_widget_table_row_new(this, gravity_left | orientation_horizontal | flags_fill));
        gui_internal_widget_append(
            row, wbc = gui_internal_button_new_with_callback(this, _("View on map"), image_new_xs(this, "gui_active"),
                                                             gravity_left_center | orientation_horizontal | flags_fill,
    ...
    if (flags & 256 && this->results_map_population) {
        gui_internal_widget_append(
            wtable, row = gui_internal_widget_table_row_new(this, gravity_left | orientation_horizontal | flags_fill));
        gui_internal_widget_append(
            row, wbc = gui_internal_button_new_with_callback(this, _("Remove search results from the map"),
    ...
    if (flags & 2048) {
        gui_internal_widget_append(
            wtable, row = gui_internal_widget_table_row_new(this, gravity_left | orientation_horizontal | flags_fill));
        gui_internal_widget_append(row, wbc = gui_internal_button_new_with_callback(
                                            this, _("Show results on the map"), image_new_xs(this, "gui_active"),
                                            gravity_left_center | orientation_horizontal | flags_fill,
    ...
    if (flags & 512) {
        gui_internal_widget_append(
            wtable, row = gui_internal_widget_table_row_new(this, gravity_left | orientation_horizontal | flags_fill));
        gui_internal_widget_append(
            row, wbc = gui_internal_button_new_with_callback(this, _("Cut Bookmark"), image_new_xs(this, "gui_active"),
                                                             gravity_left_center | orientation_horizontal | flags_fill,
        ...
        gui_internal_widget_append(
            wtable, row = gui_internal_widget_table_row_new(this, gravity_left | orientation_horizontal | flags_fill));
        gui_internal_widget_append(
            row, wbc = gui_internal_button_new_with_callback(this, _("Copy Bookmark"), image_new_xs(this, "gui_active"),
                                                             gravity_left_center | orientation_horizontal | flags_fill,
        ...
        gui_internal_widget_append(
            wtable, row = gui_internal_widget_table_row_new(this, gravity_left | orientation_horizontal | flags_fill));
        gui_internal_widget_append(row, wbc = gui_internal_button_new_with_callback(
                                            this, _("Rename Bookmark"), image_new_xs(this, "gui_active"),
                                            gravity_left_center | orientation_horizontal | flags_fill,
        ...
        gui_internal_widget_append(
            wtable, row = gui_internal_widget_table_row_new(this, gravity_left | orientation_horizontal | flags_fill));
        gui_internal_widget_append(row, wbc = gui_internal_button_new_with_callback(
                                            this, _("Paste Bookmark"), image_new_xs(this, "gui_active"),
                                            gravity_left_center | orientation_horizontal | flags_fill,
                                            gui_internal_cmd_paste_bookmark, NULL));
        gui_internal_widget_append(
            wtable, row = gui_internal_widget_table_row_new(this, gravity_left | orientation_horizontal | flags_fill));
        gui_internal_widget_append(row, wbc = gui_internal_button_new_with_callback(
                                            this, _("Delete Bookmark"), image_new_xs(this, "gui_active"),
                                            gravity_left_center | orientation_horizontal | flags_fill,
    ...
    if (wm && (wm->item.type == type_waypoint || wm->item.type == type_route_end)) {
        gui_internal_widget_append(
            wtable, row = gui_internal_widget_table_row_new(this, gravity_left | orientation_horizontal | flags_fill));
        gui_internal_widget_append(row, wbc = gui_internal_button_new_with_callback(
                                            this, _("Delete waypoint"), image_new_xs(this, "gui_active"),
                                            gravity_left_center | orientation_horizontal | flags_fill,
...
void gui_internal_cmd_bookmarks(struct gui_priv *this, struct widget *wm, void *data) {
    ...
    if (navit_get_attr(this->nav, attr_bookmarks, &mattr, NULL)) {
        if (!plen) {
            ...
            if (plen) {
                wbm = gui_internal_button_new_with_callback(this, "..", image_new_xs(this, "gui_inactive"),
                                                            gravity_left_center | orientation_horizontal | flags_fill,
                ...
                if (bookmarks_get_bookmark_count(mattr.u.bookmarks) > 0) {
                    wbm = gui_internal_button_new_with_callback(
                        this, _("Bookmarks as waypoints"), image_new_xs(this, "gui_active"),
                        gravity_left_center | orientation_horizontal | flags_fill,
                ...
                if (navit_get_destination_count(this->nav) > 0) {
                    if (bookmarks_get_bookmark_count(mattr.u.bookmarks) == 0) {
                        wbm = gui_internal_button_new_with_callback(
                            this, _("Save waypoints"), image_new_xs(this, "gui_active"),
                            gravity_left_center | orientation_horizontal | flags_fill,
                            gui_internal_cmd_replace_bookmarks_from_waypoints, NULL);
                    } else {
                        wbm = gui_internal_button_new_with_callback(
                            this, _("Replace with waypoints"), image_new_xs(this, "gui_active"),
                            gravity_left_center | orientation_horizontal | flags_fill,
                            gui_internal_cmd_replace_bookmarks_from_waypoints, NULL);
                    }
                    wbm->prefix = g_strdup(prefix);
                ...
                // delete empty folder
                if (bookmarks_get_bookmark_count(mattr.u.bookmarks) == 0) {
                    gui_internal_widget_append(w, wbm = gui_internal_button_new_with_callback(
                                                      this, _("Delete Folder"), image_new_xs(this, "gui_active"),
                                                      gravity_left_center | orientation_horizontal | flags_fill,
        ...
        wbm = gui_internal_button_new_with_callback(this, _("Add Bookmark folder"), image_new_xs(this, "gui_active"),
                                                    gravity_left_center | orientation_horizontal | flags_fill,
                                                    gui_internal_cmd_add_bookmark_folder2, NULL);
        gui_internal_widget_append(w, wbm);

        // Pastes the Bookmark
        wbm = gui_internal_button_new_with_callback(this, _("Paste bookmark"), image_new_xs(this, "gui_active"),
                                                    gravity_left_center | orientation_horizontal | flags_fill,
                                                    gui_internal_cmd_paste_bookmark, NULL);
        gui_internal_widget_append(w, wbm);
        ...
        while ((item = bookmarks_get_item(mattr.u.bookmarks))) {
            ...
            wbm = gui_internal_button_new_with_callback(
                this, label_full, image_new_xs(this, hassub ? "gui_inactive" : "gui_active"),
                gravity_left_center | orientation_horizontal | flags_fill,
...
void gui_internal_cmd_map_download(struct gui_priv *this, struct widget *wm, void *data) {
    ...
    gui_internal_widget_append(wb, w);
    if (!search) {
        wma = gui_internal_button_map_attr_new(
            this, _("Active"), gravity_left_center | orientation_horizontal | flags_fill, map, &on, &off, 1);
    ...
    wma = gui_internal_button_map_attr_new(this, _("Download Enabled"),
                                           gravity_left_center | orientation_horizontal | flags_fill, map,
                                           &download_enabled, &download_disabled, 0);
    gui_internal_widget_append(w, wma);
    ...
    while (f && fgets(buffer, sizeof(buffer), f)) {
        ...
        if (search && !strcmp(buffer, search)) {
            wma = gui_internal_button_new_with_callback(this, _("Download completely"), NULL,
                                                        gravity_left_center | orientation_horizontal | flags_fill,
                                                        gui_internal_cmd_map_download_do, map);
        ...
        if (sp == sp_match && found && buffer[sp]) {
            ...
            wma = gui_internal_button_new_with_callback(this, description_size, NULL,
                                                        gravity_left_center | orientation_horizontal | flags_fill,
                                                        gui_internal_cmd_map_download, map);
...
static void gui_internal_cmd_show_nmea_data(struct gui_priv *this, struct widget *wm, void *data) {
    ...
    if (vehicle_get_attr(v, attr_position_nmea, &attr, NULL))
        gui_internal_widget_append(w,
                                   gui_internal_text_new(this, attr.u.str, gravity_left_center | orientation_vertical));
    gui_internal_menu_render(this);
}
...
static void gui_internal_cmd_show_vehicle_dimensions(struct gui_priv *this, struct widget *wm, void *data) {
    ...
    wdemissionclass = gui_internal_button_new_with_callback(
        this, _(str), image_new_xs(this, "gui_tools"), gravity_left_center | orientation_horizontal | flags_fill,
...
static void gui_internal_cmd_set_active_profile(struct gui_priv *this, struct widget *wm, void *data) {
    ...
    gui_internal_set("navit.vehicleprofile=*",
                     g_strdup_printf("navit.vehicleprofile=navit.vehicleprofile[@name==\"%s\"]", profilename));
...
static void gui_internal_add_vehicle_profile(struct gui_priv *this, struct widget *parent, struct vehicle *v,
    ...
    // Add the button
    gui_internal_widget_append(parent, gui_internal_button_new_with_callback(
...
void gui_internal_menu_vehicle_settings(struct gui_priv *this, struct vehicle *v, char *name) {
    ...
    gui_internal_widget_append(
        w, row = gui_internal_widget_table_row_new(this, gravity_left | orientation_horizontal | flags_fill));
    gui_internal_widget_append(row, gui_internal_button_new_with_callback(
                                        this, _(g_strdup_printf(_("Change settings for: %s"), _(active_profile->name))),
                                        image_new_xs(this, "gui_tools"),
                                        gravity_left_center | orientation_horizontal | flags_fill,
 ...
 *
 * @param[in] this Our gui context
 * @param ignore Whether the current triggering button press should be ignored by subsequent handlers (see
 * navit_ignore_button())
...
static void gui_internal_setup(struct gui_priv *this) {
    ...
    if (this->background) /* When this->background is non NULL, we know we have already been initialized (thus already
                             went through gui_internal_setup() previously) */
        return;
...
static void gui_internal_resize(void *data, int wnew, int hnew) {
    ...
    if (this->root.children) {
        if (changed) {
            ...
            if (l) {
                w = l->data;
                if (!gui_internal_widget_reload_href(
                        this, w)) { /* If the foremost widget is a HTML menu, reload & redraw it from its href */
 ...
 * gui_internal_show_coord_actions() with these arguments
 *
 ...
 * @param[in] c The geographical coordinates to use (or NULL if we just want to probe that this feature is supported
 * without actually displaing the menu)
 * @param[in] description A label to use for the geographical coordinates (ex: "Map Point"), or NULL if no specific
 * label has been chosen. In that case, we will use the geographical coordinates as a label
 *
...
static int gui_internal_show_coord_actions(struct gui_priv *this, struct pcoord *c, char *description) {
    ...
    if (!this->background) {
        ...
        struct gui_internal_show_coord_args *deferred_show_coord_actions_context =
            g_malloc(sizeof(struct gui_internal_show_coord_args));
        if (description)
        ...
        struct callback *gui_internal_show_coord_actions_callback = callback_new_2(
            callback_cast(gui_internal_deferred_show_coord_actions), this, deferred_show_coord_actions_context);
        this->deferred_exec_at_init = gui_internal_show_coord_actions_callback; /* Plan execution of this callback when
                                                                                   internal GUI will be initialized */
        return 1;
    }
...
static struct gui_internal_methods gui_internal_methods_ext = {
    gui_internal_add_callback, gui_internal_remove_callback, gui_internal_menu_render, image_new_xs, image_new_l,
};
...
static struct gui_internal_widget_methods gui_internal_widget_methods = {
    gui_internal_widget_append, gui_internal_button_new, gui_internal_button_new_with_callback,
    gui_internal_box_new,       gui_internal_label_new,  gui_internal_image_new,
    gui_internal_keyboard,      gui_internal_menu,       gui_internal_get_flags,
    gui_internal_set_flags,     gui_internal_get_state,  gui_internal_set_state,
    gui_internal_set_func,      gui_internal_set_data,   gui_internal_set_default_background,
};
...
/*
 *  Command interface wrapper for commands which can be used both from gui html and to enter internal gui (for example,
 * from osd or dbus). Set first command argument to integer 1, if this command was called by mouse click from oustside
 * of gui (default). Set it to 0 if command is called by some other means (dbus signal, for example). If first argument
 * is non integer, it's passed on to actual handler.
 *
 */

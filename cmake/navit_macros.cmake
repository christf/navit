...
macro(module_add_library MODULE_NAME )
   ...
   target_link_directories(${MODULE_NAME} PRIVATE "${PROJECT_BINARY_DIR}")
   set_target_properties(${MODULE_NAME} PROPERTIES COMPILE_DEFINITIONS "MODULE=${MODULE_NAME}")
   target_link_libraries(${MODULE_NAME} PRIVATE ${${MODULE_NAME}_LIBS})
   target_link_libraries(${MODULE_NAME} PRIVATE navit_config navit_compile_options navit_deps)
   target_include_directories(${MODULE_NAME} PRIVATE "${${MODULE_NAME}_INCLUDES}")
   ...
   if (USE_PLUGINS)
      target_link_libraries(${MODULE_NAME} PRIVATE "${NAVIT_LIBNAME}")
      if (APPLE)
...
macro(supportlib_add_library LIB_NAME )
   ...
   target_link_libraries(${LIB_NAME} PRIVATE ${${LIB_NAME}_LIBS})
   target_link_libraries(${LIB_NAME} PRIVATE navit_config navit_compile_options navit_deps)
...
add_library(navit_compile_options INTERFACE)
...
macro(add_compiler_flag_if_available FLAG)
   ...
   if (${${VAR_FLAG_AVAILABLE_C}})
      target_compile_options(navit_compile_options INTERFACE ${FLAG})
   endif()

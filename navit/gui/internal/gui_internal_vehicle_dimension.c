...
static void gui_internal_cmd_change_vehicle_dimensions_weight_clicked(struct gui_priv *this, struct widget *widget,
                                                                      void *data) {
...
void gui_internal_cmd_change_vehicle_dimensions_weight(struct gui_priv *this, struct widget *wm, void *data) {
    ...
    if (this->keyboard)
        gui_internal_widget_append(
            w, gui_internal_keyboard(this, VKBD_NUMERIC | gui_internal_keyboard_init_mode(getenv("LANG"))));
    else
...
static void gui_internal_cmd_change_vehicle_dimensions_axle_weight_clicked(struct gui_priv *this, struct widget *widget,
                                                                           void *data) {
...
static void gui_internal_cmd_change_vehicle_dimensions_length_clicked(struct gui_priv *this, struct widget *widget,
                                                                      void *data) {
...
static void gui_internal_cmd_change_vehicle_dimensions_width_clicked(struct gui_priv *this, struct widget *widget,
                                                                     void *data) {
...
static void gui_internal_cmd_change_vehicle_dimensions_height_clicked(struct gui_priv *this, struct widget *widget,
                                                                      void *data) {
...
static void gui_internal_cmd_change_vehicle_dimensions_hazmat_clicked(struct gui_priv *this, struct widget *widget,
                                                                      void *data) {
...
void gui_internal_cmd_change_vehicle_dimensions_hazmat(struct gui_priv *this, struct widget *wm, void *data) {
    ...
    gui_internal_widget_append(
        wk, row = gui_internal_widget_table_row_new(this, gravity_left | orientation_horizontal | flags_fill));
...
static void gui_internal_cmd_change_vehicle_dimensions_emissionclass_clicked(struct gui_priv *this,
                                                                             struct widget *widget, void *data) {
...
void gui_internal_cmd_change_vehicle_dimensions_emissionclass(struct gui_priv *this, struct widget *wm, void *data) {
    ...
    while (ec < EMISSION_CLASS_MAX) {
        ...
        gui_internal_widget_append(row, gui_internal_button_new_with_callback(
                                            this, class, image_new_xs(this, active ? "gui_active" : "gui_inactive"),
                                            gravity_left_center | orientation_horizontal | flags_fill,
...
static void gui_internal_cmd_change_vehicle_dimensions_lez_clicked(struct gui_priv *this, struct widget *widget,
                                                                   void *data) {

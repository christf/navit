...
#define dbg(level, ...)                                                                                                \
    {                                                                                                                  \
        if (max_debug_level >= level)                                                                                  \
            debug_printf(level, dbg_module, strlen(dbg_module), __PRETTY_FUNCTION__, strlen(__PRETTY_FUNCTION__), 1,   \
                         __VA_ARGS__);                                                                                 \
    }
#define dbg_assert(expr)                                                                                               \
    ((expr) ? (void)0                                                                                                  \
            : debug_assert_fail(dbg_module, strlen(dbg_module), __PRETTY_FUNCTION__, strlen(__PRETTY_FUNCTION__),      \

...
int Xpm2bmp_paint(PXPM2BMP pXpm2bmp, HDC hdc, int x1, int y1) {
    StretchDIBits(hdc, x1, y1, pXpm2bmp->size_x, pXpm2bmp->size_y, 0, 0, pXpm2bmp->size_x, pXpm2bmp->size_y,
                  pXpm2bmp->wimage_data_trans, (BITMAPINFO *)pXpm2bmp->bmih_trans, DIB_RGB_COLORS, SRCAND);

    StretchDIBits(hdc, x1, y1, pXpm2bmp->size_x, pXpm2bmp->size_y, 0, 0, pXpm2bmp->size_x, pXpm2bmp->size_y,
                  pXpm2bmp->wimage_data, (BITMAPINFO *)pXpm2bmp->bmih, DIB_RGB_COLORS, SRCPAINT);
        ...
        while (fgets(line, sizeof(line), file_xpm)) {
            ...
            case 0:
                ...
                for (i = 1; i < pXpm2bmp->colors; i++) {
                    pXpm2bmp->color_entires[i].color_str = pXpm2bmp->color_entires[0].color_str
                                                           + (pXpm2bmp->chars_per_pixel + 1) * i;
                }
                ...
                if (!(pXpm2bmp->dib =
                          (unsigned char *)g_malloc(sizeof(BITMAPINFOHEADER) + rowsize * pXpm2bmp->size_y))) {
                    return 4;
                }
                if (!(pXpm2bmp->dib_trans =
                          (unsigned char *)g_malloc0(sizeof(BITMAPINFOHEADER) + rowsize * pXpm2bmp->size_y))) {
                    return 4;
                }
            ...
            case 1:
                ...
                break;
            case 2:
                parse_pixel_line_values(line, pXpm2bmp, pXpm2bmp->wimage_data + row * rowsize,

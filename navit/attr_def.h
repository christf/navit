...
ATTR(distance)
ATTR(maxspeed_conditional_speed)
ATTR(maxspeed_fwd_conditional_speed)
ATTR(maxspeed_bwd_conditional_speed)
...
ATTR(outputdir)
ATTR(maxspeed_conditional_condition)
ATTR(maxspeed_fwd_conditional_condition)
ATTR(maxspeed_bwd_conditional_condition)

...
static inline int block_get_blocks(struct block *blk) {
    unsigned char *p = blk->p;
    return get_u32(&p);
}
static inline int block_get_size(struct block *blk) {
    unsigned char *p = blk->p + 4;
    return get_u32(&p);
}
static inline int block_get_next(struct block *blk) {
    unsigned char *p = blk->p + 8;
    return get_u32(&p);
}
static inline int block_get_count(struct block *blk) {
    unsigned char *p = blk->p + 28;
    return get_u32(&p);
}
static inline void block_get_r(struct block *blk, struct coord_rect *r) {
    unsigned char *p = blk->p + 12;
    r->lu.x = get_u32(&p);
    r->lu.y = get_u32(&p);
    r->rl.x = get_u32(&p);
    r->rl.y = get_u32(&p);
...
static inline unsigned char street_header_get_order(struct street_header *str) {
    return *str->p;
}
static inline int street_header_get_count(struct street_header *str) {
    unsigned char *p = str->p + 1;
...
static inline unsigned char street_type_get_order(struct street_type *str) {
    return *str->p;
}
static inline unsigned short street_type_get_country(struct street_type *str) {
    unsigned char *p = str->p + 1;
    return get_u16_unal(&p);
}
...
static inline int street_str_get_segid(struct street_str *str) {
    unsigned char *p = str->p;
    return get_u32_unal(&p);
}
static inline unsigned char street_str_get_limit(struct street_str *str) {
    return str->p[4];
}
static inline unsigned char street_str_get_unknown2(struct street_str *str) {
    return str->p[5];
}
static inline unsigned char street_str_get_unknown3(struct street_str *str) {
    return str->p[6];
}
static inline unsigned char street_str_get_type(struct street_str *str) {
    return str->p[7];
}
static inline unsigned int street_str_get_nameid(struct street_str *str) {
    unsigned char *p = str->p + 8;
    return get_u32_unal(&p);
}
...
static inline unsigned short block_offset_get_offset(struct block_offset *blk) {
    unsigned char *p = blk->p;
    return get_u16_unal(&p);
}
static inline unsigned short block_offset_get_block(struct block_offset *blk) {
    unsigned char *p = blk->p + 2;
    return get_u16_unal(&p);
}

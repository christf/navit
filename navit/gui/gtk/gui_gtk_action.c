...
static GtkActionEntry entries[] = {
    /* TRANSLATORS: These texts are for menu items in GTK GUI. The _ indicates the mnemonic key (=underlined character)
       for this menu item. Please place the _ before a suitable character in the translation (or omit it if no mnemonic
       key is desired). */
...
static GtkToggleActionEntry toggleentries[] = {
    ...
    {"FullscreenAction",    GTK_STOCK_FULLSCREEN,   _n("_Fullscreen"),                    "<control>F", NULL,
     G_CALLBACK(window_fullscreen_action),                                                                                                                                    FALSE}
#else
...
static const char *cursor_xpm[] = {"22 22 2 1",
                                   " 	c None",
                                   ".	c #0000FF",
                                   "                      ",
                                   "                      ",
...
static const char *north_xpm[] = {"22 22 2 1",
                                  " 	c None",
                                  ".	c #000000",
                                  "                      ",
                                  "                      ",
...
static const char *flag_xpm[] = {"22 22 2 1",
                                 " 	c None",
                                 "+	c #000000",
                                 "+++++++               ",
                                 "+   +++++++++         ",

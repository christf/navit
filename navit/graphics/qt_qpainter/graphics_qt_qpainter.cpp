...
static struct event_methods event_qt_methods = {
    .event_main_loop_run = event_qt_main_loop_run,
    .event_main_loop_quit = event_qt_main_loop_quit,
    .event_add_watch = event_qt_add_watch,
    .event_remove_watch = event_qt_remove_watch,
    .event_add_timeout = event_qt_add_timeout,
    .event_remove_timeout = event_qt_remove_timeout,
    .event_add_idle = event_qt_add_idle,
    .event_remove_idle = event_qt_remove_idle,
    .event_call_callback = event_qt_call_callback  //
};

struct event_priv {};

struct event_priv *event_qt_new(struct event_methods *meth) {
    dbg(lvl_debug, "enter");

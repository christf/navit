...
static enum item_type selectors_FuelTypes[] = {type_poi_fuel, type_poi_fuel, type_poi_charging_station, type_none};
...
static enum item_type selectors_HotelTypes[] = {type_poi_hotel,   type_poi_camp_rv, type_poi_camping,
                                                type_poi_camping, type_poi_resort,  type_poi_resort,
                                                type_poi_motel,   type_poi_hostel,  type_none};
static enum item_type selectors_RestaurantTypes[] = {type_poi_bar,
                                                     type_poi_picnic,
                                                     type_poi_burgerking,
                                                     type_poi_fastfood,
                                                     type_poi_restaurant,
                                                     ...
                                                     type_poi_pub,
                                                     type_none};
static enum item_type selectors_ShoppingTypes[] = {type_poi_mall,
                                                   type_poi_mall,
                                                   type_poi_shop_grocery,
                                                   type_poi_shop_grocery,
                                                   type_poi_shopping,
                                                   type_poi_shopping,
                                                   type_poi_shop_butcher,
                                                   type_poi_shop_baker,
                                                   type_poi_shop_fruit,
                                                   type_poi_shop_fruit,
                                                   type_poi_shop_beverages,
                                                   type_poi_shop_beverages,
                                                   type_none};
static enum item_type selectors_ServiceTypes[] = {type_poi_marina,
                                                  type_poi_marina,
                                                  type_poi_hospital,
                                                  type_poi_hospital,
                                                  ...
                                                  type_poi_public_utilities,
                                                  type_poi_police,
                                                  type_poi_autoservice,
                                                  type_poi_information,
                                                  type_poi_information,
                                                  type_poi_pharmacy,
                                                  type_poi_pharmacy,
                                                  type_poi_personal_service,
...
static enum item_type selectors_OtherTypes[] = {type_point_unspecified,
                                                type_poi_land_feature - 1,
                                                type_poi_rock + 1,
                                                type_poi_fuel - 1,
                                                ...
                                                type_poi_shopping - 1,
                                                type_poi_shopping + 1,
                                                type_poi_car_parking - 1,
                                                type_poi_car_parking + 1,
                                                type_poi_bar - 1,
                                                type_poi_bank + 1,
                                                type_poi_dam - 1,
                                                type_poi_dam + 1,
                                                type_poi_information - 1,
                                                type_poi_information + 1,
                                                type_poi_mall - 1,
                                                type_poi_mall + 1,
                                                type_poi_personal_service - 1,
                                                type_poi_pharmacy + 1,
                                                type_poi_repair_service - 1,
                                                type_poi_repair_service + 1,
                                                type_poi_restaurant - 1,
                                                type_poi_restaurant + 1,
                                                type_poi_restroom - 1,
                                                type_poi_restroom + 1,
                                                type_poi_shop_grocery - 1,
                                                type_poi_shop_grocery + 1,
                                                type_poi_peak - 1,
                                                type_poi_peak + 1,
                                                type_poi_motel - 1,
                                                type_poi_hostel + 1,
                                                type_poi_shop_butcher - 1,
                                                type_poi_shop_baker + 1,
                                                type_poi_shop_fruit - 1,
                                                type_poi_shop_fruit + 1,
...
static struct widget *gui_internal_cmd_pois_selector(struct gui_priv *this, struct pcoord *c, int pagenb) {
    ...
    for (i = 0; i < nitems; i++) {
        ...
        p->filter = NULL;
        p->filterstr = NULL;
        gui_internal_widget_append(wl, wb = gui_internal_button_new_with_callback(
                                           this, NULL, image_new_s(this, selectors[i].icon),
                                           gravity_left_center | orientation_vertical, gui_internal_cmd_pois, p));
        wb->c = *c;
    ...
    gui_internal_widget_append(wl, wb = gui_internal_button_new_with_callback(
                                       ...
                                       gravity_left_center | orientation_vertical, gui_internal_cmd_pois_filter, NULL));
    wb->c = *c;
    wb->bt = 10;
...
struct widget *gui_internal_cmd_pois_item(struct gui_priv *this, struct coord *center, struct item *item,
    ...
    wl = gui_internal_button_new_with_callback(this, text, icon,
                                               gravity_left_center | orientation_horizontal | flags_fill, NULL, NULL);
    wl->datai = dist;
    g_free(text);
    if (name[0]) {
